...
export const Hero = () => {
    return(
        <div className="flex flex-col md:flex-row md:pb-7 md:pt-0 p-4 overflow-x-auto items-center md:items-start">
        <Image src="/profile.png" alt="Avatar" className="w-32 h-32 md:w-40 md:h-40 p-2 rounded-2xl flex-shrink-0 mb-4 md:mb-0" width={150} height={150} />
        <div className="md:pl-3 md:pt-10 min-w-0 text-center md:text-left">
